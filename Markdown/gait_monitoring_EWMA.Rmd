...
for (id in setdiff(1:15, 13)) {
  ...
  video <- read.csv(paste0(file="C:/Users/Saeb/Dropbox/SPC Gait Profile/Data/Csv_files/Sub", id, ".csv"))
  ...
  ################################################### Read from mat files
  raw1 <- readMat(paste0("C:/Ergonomics lab/IMU data processing/Matlab Segmentation/low cutoff segment/EndToEnd_output/Subject", id, "_aZ_seg.mat"))
